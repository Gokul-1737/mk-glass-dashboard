    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white/10 border-white/20 p-0 opacity-70 hover:opacity-100 text-white hover:bg-white/20"
        ),
        ...
        day_outside:
          "day-outside text-white/50 opacity-50 aria-selected:bg-white/10 aria-selected:text-white/50 aria-selected:opacity-30",
