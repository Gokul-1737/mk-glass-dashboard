...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-fade-in p-4 sm:p-0 relative">
      {/* Online Market Background */}
      <div 
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between animate-slide-in-top">
          <h1 className="text-2xl sm:text-3xl font-bold text-white">🏪 MK Shopping Dashboard</h1>
          <p className="text-white/70 hidden sm:block">Sales Analytics Portal</p>
        </div>
